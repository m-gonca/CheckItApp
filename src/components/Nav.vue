  ...
  ></span>
    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div class="flex md:order-2 gap-4">
        <!-- DATE -->
        <div class="hidden justify-between gap-2 items-center w-full md:flex md:w-auto md:order-first">
          <h3>Today is</h3>
        ...
        <button
          type="button"
          @click="signOut"
          class="text-white text-sm font-medium bg-teal-600 hover:bg-violet-400 focus:ring-4 focus:ring-blue-300 rounded-lg px-5 py-2.5 text-center mr-3 md:mr-0"
        >
          Log out
        </button>
