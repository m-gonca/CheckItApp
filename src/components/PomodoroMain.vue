  ...
  <div class="w-full flex flex-col gap-10 2xl:w-2/3">
    ...
    >
      ...
      >
        ...
        <form @submit.prevent="signIn" class="text-white flex flex-col border-4 bg-violet-400/80 rounded-xl">
          <div class="flex">
            <div class="flex flex-col w-1/3 p-2 gap-1">
          ...
          <div class="flex justify-between p-2">
            <button type="submit" class="flex w-1/2 justify-start">Update</button>
