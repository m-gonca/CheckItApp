<template>
  <div>
    <div class="flex flex-col lg:flex-row lg:items-baseline lg:w-full">
      <div class="flex flex-col gap-4 lg:flex-row lg:pt-4 lg:w-full">
        <button
        ...
        <button
          @click="timer.showSettings = true"
          class="hidden w-full rounded-xl font-semibold shadow-md duration-75 hover:bg-violet-400 bg-teal-400/80 lg:flex lg:justify-center lg:items-center lg:w-2/4 lg:px-3 lg:py-2"
        >
          <img
