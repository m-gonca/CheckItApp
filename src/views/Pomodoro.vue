  ...
  <div class="flex flex-col justify-between h-screen">
    ...
    >
      ...
      <div class="flex h-full m-auto justify-around">
        ...
        <div
          v-if="!moodChoice"
          class="flex flex-col justify-between items-center py-10 md:w-2/5 lg:py-4"
        >
          <div
          ...
          >
            <h1>First things first, <br> what's your vibe today?</h1>
          </div>
          <PomodoroCards
            :theme="theme"
        ...
        <div
          v-else
          class="flex flex-col text-white text-7xl font-semibold h-full justify-between items-center border-2 border-red-500 "
        >
          <PomodoroMain/>
          <button
              @click="showPomodoro"
              class="text-white text-2xl w-4/5 my-6 font-semibold bg-teal-400 hover:bg-violet-400 rounded-xl px-5 py-2.5 text-center lg:text-xl"
            >
